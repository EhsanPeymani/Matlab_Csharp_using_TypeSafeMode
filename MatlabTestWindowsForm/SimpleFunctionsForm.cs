...
using Interface;
using MatlabExportedFunctionsSafeType;

namespace MatlabTestWindowsForm
{
    public partial class SimpleFunctionsForm : Form
    {
        private readonly IMatlab _iMatlab = new MatlabFunctionsTypeSafeIMatlab();
        ...
        {
            descriptionLabel.Text = string.Format("This function adds up two doubles that the user has enterred.");
            ...
            {
                var result = _iMatlab.add(num1, num2);
                resultTextBox1.Text = string.Format("The sum of {0} and {1} is {2}", num1, num2, result);

                return;
            }
            
            resultTextBox1.Text = string.Format("Wrong input");
            resultTextBox2.Text = string.Empty;
            resultTextBox3.Text = string.Empty;
        }
        ...
        private void PlotMeshbutton_Click(object sender, EventArgs e)
        {
            ...
            _iMatlab.PlotMesh("MATLAB Logo - 3D Plot", "MATLAB 3D Plot");
        }
        ...
        private void plot2DBbutton_Click(object sender, EventArgs e)
        {
            ...
            _iMatlab.DisplayPlot(num1, num2, title, xLabel, yLabel, figureTitle);
        }

        private void makeMagicSquareButton_Click(object sender, EventArgs e)
        {
            descriptionLabel.Text =
                string.Format("This function recieves the dimension (hardcoded as 4), and generates a magic matrix of the same order.\n" +
            ...
            var dim = 4;
            var magicMatrix = _iMatlab.makesquare(dim);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            var magicMatrix = _iMatlab.makesquare_full(dim, out determinant, out eigenvalues);
        ...
        {
            descriptionLabel.Text =
                string.Format("This function recieves the vector (hardcoded as [1,2,3]), and uses the sum of elements\n" + 
            ...
            var magicMatrix = _iMatlab.makesquare_in_vector(dimArray);
        ...
        private void MWStructToNETbutton_Click(object sender, EventArgs e)
        {
            descriptionLabel.Text =
                string.Format("This function recieves the dimension (hardcoded as 4), and generates a magic matrix of the same order.\n" +
            ...
            var dim = 4;
            var matlabInformation = _iMatlab.makesquare_structure(dim);
        ...
        {
            descriptionLabel.Text =
                string.Format("This function recieves a MATLAB structure (hardcoded as Dimension:5, and Multipiler:10).\n" +
            ...
            MatrixInputStructure input = new MatrixInputStructure(dim, multiplier);

            var matlabInformation = _iMatlab.makesquare_in_out_structure(input);
